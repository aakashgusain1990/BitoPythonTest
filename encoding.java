...
public interface Encoding {
    ...
    class Of implements Encoding {
        ...
        public Map<String, Integer> specialTokens() {
            return Collections.unmodifiableMap(this.specialTokens);
        }
    ...
    static Encoding forName(String encodingName) {
        String lowerCaseEncodingName = encodingName.toLowerCase();
        switch (lowerCaseEncodingName) {
            case "cl100k_base":
                return CL100K_BASE;
            case "p50k_base":
                return P50K_BASE;
